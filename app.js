...
function createTask(taskTitle) {
    ...
    newTask.classList.add('todo' ,'list-group-item', 'grid' ,'grid-cols-6' ,'bg-gray-200' ,'py-2' ,'items-center', 'rounded-md', 'mb-4')

    const newCheckbox = document.createElement('input')
    newCheckbox.classList.add('form-check-input', 'todo','col-span-1', 'flex', 'justify-start', 'pl-1')
    ...
    newLabel.classList.add('ms-2', 'form-check-label', 'col-span-4')
...
function createTrash() {
    const newTrash = document.createElement('label', 'flex', 'justify-end', 'pr-5')
    newTrash.classList.add('ms-auto', 'btn', 'btn-danger', 'btn-sm', 'col-span-1')

    const newIcon = document.createElement('i')
    newIcon.classList.add('bi-trash', 'flex', 'justify-end', 'pr-5', 'cursor-pointer')
